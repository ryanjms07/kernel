...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_VIRTOUS)
extern struct cpufreq_governor cpufreq_gov_virtous;
#define CPUFREQ_DEFAULT_GOVERNOR (&cpufreq_gov_virtous)
...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_LULZACTIVE2)
extern struct cpufreq_governor cpufreq_gov_lulzactive2;
#define CPUFREQ_DEFAULT_GOVERNOR (&cpufreq_gov_lulzactive2)
...
extern struct cpufreq_governor cpufreq_gov_sacuractive;
#define CPUFREQ_DEFAULT_GOVERNOR (&cpufreq_gov_sacuractive)
